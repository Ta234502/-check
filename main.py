...
def parse_record_command(message_text: str) -> dict:
    ...
    if len(tokens) < 3:
        raise ValueError("Usage: /record <duration> [bitrate-ignored] <m3u8_url> [file_name] [--referer URL] [--header 'Key: Value'] [--audio-only|--video-only]")
